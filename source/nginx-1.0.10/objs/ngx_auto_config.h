#define NGX_CONFIGURE " --prefix=/opt/opscode/embedded --with-http_ssl_module --with-ld-opt=-L/opt/opscode/embedded/lib --with-cc-opt='-L/opt/opscode/embedded/lib -I/opt/opscode/embedded/include' --with-zlib=/opt/opscode/embedded/lib --with-openssl=/opt/opscode/embedded/lib"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.5.2 (Ubuntu/Linaro 4.5.2-8ubuntu4) "
#endif
